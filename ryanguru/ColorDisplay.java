...
public class ColorDisplay {
	...
	private static int STD_PIXEL_SIZE = 40;
	private static int PIXEL_SIZE;
	private static int H_MAX_PIX = 40;
	private static int V_MAX_PIX = 20;
	private static int STD_ROW_LABEL_WIDTH = 70, STD_COL_LABEL_HEIGHT = 70;
	private static int ROW_LABEL_WIDTH, COL_LABEL_HEIGHT;

	private static String[] color = { "RED", "CYAN", "GREEN", "ORANGE", "BLUE","PINK","YELLOW","WHITE","PURPLE"};
	...
	public static void setPixelColorRGB(int r, int c, int redval, int greenval, int blueval) {

		screen[r][c].setColor(pickColor(redval,greenval,blueval));
		window.repaint();
	}
	private static Color pickColor(int redval, int greenval, int blueval)
	{
	        Color result;
	        result = new Color(redval, greenval, blueval);
	        return result;
	    }
